...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTEACCION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTEACCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTEACCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTEACCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTEACCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTEACCION actions', async () => {
      const expectedActions = [
        {
